...
Begin MobileContainer ExpenseDetailContainer
   ...
   Begin MobileMapViewer ExpenseMap
      ...
      AutoLayout      =   ExpenseMap, 3, CategoryTable1, 4, False, +1.00, 4, 1, 40, , True
      ControlCount    =   0
      Enabled         =   True
      Height          =   217
      Latitude        =   0.0
      ...
      _ClosingFired   =   False
   End
   Begin iOSMobileTable CategoryTable1
      AccessibilityHint=   ""
      AccessibilityLabel=   ""
      AllowRefresh    =   False
      AllowSearch     =   False
      AutoLayout      =   CategoryTable1, 1, <Parent>, 1, False, +1.00, 4, 1, 5, , True
      AutoLayout      =   CategoryTable1, 2, ExpenseMap, 2, False, +1.00, 4, 1, 0, , True
